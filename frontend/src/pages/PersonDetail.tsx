                    ...
                    {person.events.map((event) => (
                        <div className="flex flex-col sm:flex-row justify-between items-start gap-6">
                            <div className="space-y-2 flex-1">
                                ...
                                {event.notes && (
                                    <p className="text-sm text-gray-500 italic mt-1 border-l-2 border-gray-100 pl-3">
                                        {event.notes}
                                    </p>
                                )}
                            </div>
                            <div className="mt-2 sm:mt-0 sm:self-center flex-shrink-0">
                                <Link
                                    to={`/artworks/${event.artwork_id}`}
                                    className="flex items-center gap-1.5 text-xs font-medium text-slate-500 hover:text-indigo-600 bg-slate-50 hover:bg-indigo-50 px-3 py-1.5 rounded-lg transition-all border border-slate-100"
                                >
