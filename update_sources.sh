...
# Bash script to update sources in provenance events from a tab-delimited file.
# Input file format: 3 tab-delimited columns: old source, new source, notes
# Usage: ./update_sources.sh

# Prompt for file location
read -p "Enter path to update file (tab-delimited: old source, new source, notes): " inputPath
